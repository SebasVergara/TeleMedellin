...
//  String get date => DateFormat('MMMM. dd - h:mm a').format(DateTime.parse(this.modifiedGmt)).toString();
  String get date => DateFormat('dd/MM/yy - h:mm a').format(DateTime.parse(this.modifiedGmt)).toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['modified'] = this.modifiedGmt;
    if (this.extra != null) {
